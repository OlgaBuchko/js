...
//     divimg.innerText=simpson.photo;
//
// }
...
for (const coursesArrayElement of coursesArray) {
    ...
    conteiner.appendChild(duration);
    conteiner.appendChild(modules);
    duration.appendChild(monthDuration);
    duration.appendChild(hourDuration);
    title.innerText = coursesArrayElement.title;
    duration.style.display='flex'
    monthDuration.innerText = coursesArrayElement.monthDuration + ' ' + 'місяців';
    hourDuration.innerText = coursesArrayElement.hourDuration +' ' + 'годин';
    hourDuration.style.marginLeft = '15px';
